...
public:
	...
	UPROPERTY()
		APieza* CurrentPiece;
		APieza* PiezaSiguiente;
		TArray<int> vectorPiezas;
	...
	IEstrategiasInterfaz* EstrategiaActual;
	void cambiarEstrategia(AActor* estrategiaPosicion);
	void SetearPosicionInicial();
	AEstrategiaBasica* EstrategiaBasica;
	AEstDeslizarIzquierdo* EstDeslizarIzquierda;
	AEstDeslizarDerecho* EstDeslizarDerecha;
	//-----------------------------------------------
	//The Builder Actor
	...
	UPROPERTY(VisibleAnywhere, Category = "Principal")
		class ADirectorPiezas* DirectorPS;
